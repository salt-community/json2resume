...
function SectionHeaders({ resumeData, setResumeData }: Props) {
  ...
  const sections: Array<{ key: keyof SectionHeaders; label: string; description: string }> = [
    { key: 'work', label: 'Work Experience', description: 'Professional employment history' },
    { key: 'volunteer', label: 'Volunteer Experience', description: 'Community service and volunteer work' },
    { key: 'education', label: 'Education', description: 'Academic background and qualifications' },
    { key: 'awards', label: 'Awards', description: 'Recognition and achievements' },
    { key: 'certificates', label: 'Certificates', description: 'Professional certifications' },
    { key: 'publications', label: 'Publications', description: 'Published works and articles' },
    ...
    { key: 'interests', label: 'Interests', description: 'Personal interests and hobbies' },
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg bg-muted/50 p-4">
        ...
        <div className="text-xs text-muted-foreground space-y-1">
          <p>These headers will appear as section titles in your resume template.</p>
